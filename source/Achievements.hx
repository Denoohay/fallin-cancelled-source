...
class AchievementObject extends FlxSpriteGroup {
	...
	public function new(name:String, ?camera:FlxCamera = null)
	{
		...
		var achievementBG:FlxSprite = new FlxSprite(60, 50).makeGraphic(420, 120, FlxColor.TRANSPARENT);
		...
		alphaTween = FlxTween.tween(this, {alpha: 0}, 0.5, {onComplete: function (twn:FlxTween) {
