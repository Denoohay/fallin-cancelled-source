...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		for (i in 0...WeekData.weeksList.length)
		{
			...
			var weekThing:MenuItem = new MenuItem(0, bgSprite.y + 396);
		...
		var charArray:Array<String> = weekCharacters[curWeek];
		for (char in 0...3)
		{
	...
	function changeWeek(change:Int = 0):Void
	{
		...
		var leName:String = weekNames[curWeek];
		...
		var assetName:String = weekNames[curWeek];
	...
	function updateText()
	{
		var weekArray:Array<String> = weekCharacters[curWeek];
		for (i in 0...grpWeekCharacters.length) {
			grpWeekCharacters.members[i].changeCharacter(weekArray[i]);
		}

		var leWeek:WeekData = weekData[curWeek];
