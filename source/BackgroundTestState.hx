...
class BackgroundTestState extends MusicBeatState
{
...
//$ This whole section is just for the background
		...
		function makeBackground():Void
		{
			var lastX:Int = 0;
			var lastY:Int = 0;
			var imgAssetStr = "assets/images/fallmen/UI/Menu/Customize/Patterns/default.png";
...
//$ and the background section ends here. ughghughhh
	...
	override function update(elapsed:Float)
	{
		...
		{
			MusicBeatState.switchState(new BackgroundStillState());
		}
