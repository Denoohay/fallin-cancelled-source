...
class CharacterEditorState extends MusicBeatState
{
	...
	var BFprevSkin:String;
	var GFprevSkin:String;
	var FGprevSkin:String;
	...
	override function create()
	{
		...
		BFprevSkin = FlxG.save.data.BFskin;
		GFprevSkin = FlxG.save.data.GFskin;
		FGprevSkin = FlxG.save.data.FGskin;
	...
	override function update(elapsed:Float)
	{
		...
		if(!charDropDown.dropPanel.visible) {
			if (FlxG.keys.justPressed.ESCAPE) {
				FlxG.mouse.useSystemCursor = true;
				FlxG.save.data.BFskin = BFprevSkin;
				FlxG.save.data.GFskin = GFprevSkin;
				FlxG.save.data.FGskin = FGprevSkin;
				if(goToPlayState) {
